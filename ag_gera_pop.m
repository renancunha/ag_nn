function [individuos] = ag_gera_pop( POP_SIZE )
 %POP_SIZE = 10;   
    ...
    for i = 1:POP_SIZE
        ...
        net_LW{camadas} = rand(3,n_neuronios_camada(camadas));
        net_bias{camadas+1} =rand(3,1);
        ...
        info = {net_bias{camadas+1},funcoes_net{camadas+1}};
